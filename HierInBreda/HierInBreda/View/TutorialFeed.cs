...
namespace WindowsBlogReader
{
    ...
    {
        private ObservableCollection<TutorialFeed> _Feeds = new ObservableCollection<TutorialFeed>();
        public ObservableCollection<TutorialFeed> Feeds
        {
            get
            {
                return this._Feeds;
        ...
        private async Task<TutorialFeed> GetFeedAsync(string feedUriString)
        {
            ...
            try
            {
                ...
                TutorialFeed feedData = new TutorialFeed();
        ...
        public static TutorialFeed GetFeed(string title)
        {
